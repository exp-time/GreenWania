...
function createAddress(lang) {
  ...
  new Elem({tag: 'div', attrs: {className: 'button font-jumbo dark-green btn-container2', innerHTML: '&mapstoup;',
...
function changeTab(tab, init) {
  ...
  currentTab = tab
  document.getElementById(currentTab).className = "button font-large theme-bg contrastbtn padding-3"
