...
function changeTab(tab, init) {
  ...
  if (currentTab === "tabOne") {
    ...
    new Elem({tag: 'div', attrs: {className: "centerimg"}, children:[
      {tag: 'a', attrs: {className: "button dark-grey", style:"position:absolute;top:45%;left:18%;", onclick:()=>plusDivs(-1), textContent: "<"}},
      {tag: 'a', attrs: {className: "button dark-grey", style:"position:absolute;top:45%;right:18%;", onclick:()=>plusDivs(+1), textContent: ">"}},
